    ...
    <section class="section">
        <div class="container">
            <div class="columns">
                ...
                <div id="grundgeruest" class="column is-9">
                    <div class="content">
                        <h4 class="title is-4">HTML Grundgerüst</h4>
                        <div class="box">
                            <div class="block">
                                <p>
                                    Jedes <abbr title="Hypertext Markup Language">HTML</abbr> Dokument verwendet ein
                                    paar grundlegende Elemente. Diese definieren noch nicht den Inhalt der Webseite. Sie
...
&lt;/html>
                                ...
                                <p>
                                    Alle Elemente aus dem Grundgerüst sollten für <b>jede</b> Webseite notiert werden.
                                </p>
