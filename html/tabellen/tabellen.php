    ...
    <section class="section">
        <div class="container">
            <div class="columns">
                ...
                <div id="tabellen" class="column is-9">
                    <div class="content">
                        <h4 class="title is-4">HTML Tabellen</h4>
                        <div class="box">
                            <div class="block">
                                <p>
                                    Tabellen spielten für einen gewissen Zeitraum eine wesentliche Rolle in der
                                    Webentwicklung. Man verwendete Tabellen nicht nur um Inhalte in Form von Zeile und
                                    Spalten darzustellen, sondern setzte Tabellen auch für die Webseitenstruktur ein.
                                    ...
                                    Webdesign sieht dies jedoch als einen veralteten und schlechten Stil an. Modernes
                                    Webdesign verwendet <abbr title="Hypertext Markup Language">HTML</abbr>-Elemente und
...
&lt;/table>
                                ...
                                <div class="notification is-info mt-5">
                                    ...
                                    einheitlich dargestellt. So sind die Zellen innerhalb einer Spalte mit dem gleichen
                                    Abstand visualisiert. Mit <abbr title="Cascading Style Sheets">CSS</abbr> kann man
                                ...
                                <div class="tags">
                                    <a class="tag" href="#table">table</a>
                                    <a class="tag" href="#caption">caption</a>
                                    <a class="tag" href="#thead">thead</a>
                                    <a class="tag" href="#tbody">tbody</a>
                                    <a class="tag" href="#tfoot">tfoot</a>
                                    <a class="tag" href="#tr">tr</a>
                                    <a class="tag" href="#td">td</a>
                                    <a class="tag" href="#th">th</a>
                                    <a class="tag" href="#colspan">colspan</a>
                                    <a class="tag" href="#rowspan">rowspan</a>
                                </div>
                            </div>
                        </div>
