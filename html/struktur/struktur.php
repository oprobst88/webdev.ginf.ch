    ...
    <section class="section">
        <div class="container">
            <div class="columns">
                ...
                <div id="struktur" class="column is-9">
                    <div class="content">
                        <h4 class="title is-4">HTML Webseitenstruktur</h4>
                        <div class="box">
                            <div class="block">
                                <p>
                                    <abbr title="Hypertext Markup Language">HTML</abbr> stellt Elemente zur Verfügung,
                                    ...
                                    Inhalt der Webseite in Funktionalitäten (wie zum Beispiel Header, Footer oder Menü)
                                    einzuteilen. Davon können auch Technologien, welche ein barrierefreies Arbeiten am
                                    Computer ermöglichen (zum Beispiel Screenreader) profitieren. Die Elemente können
                                    auch mit <abbr title="Cascading Style Sheets">CSS</abbr> visuell gestaltet werden
